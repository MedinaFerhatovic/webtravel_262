...
@Injectable() export class BookingService {
    ...
    create(UserID: string, DestID: string, FullName: string, Persons: number, Start: string, End: string) {
    ...
    update(id: string, UserID: string, DestID: string, FullName: string, Persons: number, Start: string, End: string) {
